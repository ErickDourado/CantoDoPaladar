...
public class ProdutoController {
    ...
    @GetMapping("/{id}")
    public ResponseEntity<ProdutoResponse> findById(@PathVariable("id") final Long id) {
    ...
    @PutMapping("/{id}")
    public ResponseEntity<ProdutoResponse> update(@PathVariable("id") final Long id,
